...
Prowl is a browser whose whole point is protecting people. Security reports are the most valuable contribution you can make.
...
- Which Prowl version and operating system you tested on.
...
- The password manager and Prowl Wallet (both are end-to-end encrypted on the device — anything that breaks that is critical).
